...
public class TelaCadastroLivros extends JFrame {
    ...
    private void configurarJanela() {
        ...
        setTitle("BiblioTech - Cadastro de Livros");
    ...
    private JPanel criarPainelCadastro() {
        ...
        painelInfo.setMaximumSize(
                new Dimension(
                        Integer.MAX_VALUE,
                        90));

        conteudo.add(painelInfo);
    ...
    private JPanel criarPainelInformacoes() {
        ...
        painel.add(criarCampo("Título"));
        painel.add(criarCampo("Autor"));
        painel.add(criarCampo("Ano"));
        painel.add(criarCampo("Quantidade"));
